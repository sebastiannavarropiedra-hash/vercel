...
QUnit.test("main case - hashed-tree traversal - map over", function exec_test(assert) {
  ...
  var lenses = {
    ...
    constructTree: function constructTree(label, children) {
      ...
      var parentCursor = makeParentCursor(cursor, sep);
  ...
  var actual = mapOverHashTree(lenses, function (label) {
    return 'M-' + label;
  }, obj);
  var expected = {};
...
},{"qunitjs":7,"process":6}],9:[function(require,module,exports) {
...
//# sourceMappingURL=/_tree.specs.7c66778e.map