...
var QUnit = _interopRequireWildcard(_qunitjs);
...
QUnit.test("main case - preorderTraverseTree", function exec_test(assert) {
  var actual = (0, _.preorderTraverseTree)(lenses, traverse, tree);
  var expected = ["root", "left", "middle", "midleft", "midright", "right"];

  assert.deepEqual(actual, expected, "Works!");
});

QUnit.test("main case - breadthFirstTraverseTree", function exec_test(assert) {
  var actual = (0, _.breadthFirstTraverseTree)(lenses, traverse, tree);
  var expected = ["root", "left", "middle", "right", "midleft", "midright"];

  assert.deepEqual(actual, expected, "Works!");
});

QUnit.test("main case - postOrderTraverseTree", function exec_test(assert) {
  var actual = (0, _.postOrderTraverseTree)(lenses, traverse, tree);
  var expected = ["left", "midleft", "midright", "middle", "right", "root"];

  assert.deepEqual(actual, expected, "Works!");
});

QUnit.test("main case - reduceTree", function exec_test(assert) {
  var reduceTraverse = merge(traverse, { "strategy": _.BFS });
  var actual = (0, _.reduceTree)(lenses, reduceTraverse, tree);
  var expected = ["root", "left", "middle", "right", "midleft", "midright"];
...
QUnit.test("main case - forEachInTree", function exec_test(assert) {
  var traces = [];
  var traverse = {
    strategy: _.POST_ORDER,
    action: function action(tree, traversalState) {
      traces.push(traversalState.get(tree));
      traces.push(tree.label);
    }
  };

  (0, _.forEachInTree)(lenses, traverse, tree);
  var actual = traces;
  var expected = [{
    "isAdded": true,
    "isVisited": false,
...
QUnit.test("main case - mapOverTree", function exec_test(assert) {
  var getChildren = function getChildren(tree) {
    return tree.children || [];
  };
  var getLabel = function getLabel(tree) {
    return tree.label || '';
  };
  var constructTree = function constructTree(label, trees) {
    return { label: label, children: trees };
  };
  var mapFn = function mapFn(label) {
    return addPrefix('Map:')(label);
  };
  var lenses = { getChildren: getChildren, constructTree: constructTree, getLabel: getLabel };

  var actual = (0, _.mapOverTree)(lenses, mapFn, tree);
  var expected = {
    "children": [{
      "children": [],
      "label": "Map:left"
...
QUnit.test("main case - pruneWhen", function exec_test(assert) {
  ...
  var predicate = function predicate(tree, traversalState) {
    return traversalState.get(tree).path.length > 1;
  };
  var lenses = { getChildren: getChildren, constructTree: constructTree, getLabel: getLabel };

  var actual = (0, _.pruneWhen)(lenses, predicate, tree);
  var expected = {
    "children": [{
      "children": [],
      "label": "left"
...
QUnit.test("main case - object traversal - map over", function exec_test(assert) {
  ...
  var actual = (0, _.mapOverObj)({ key: function key(_key) {
      return 'K' + _key;
    }, leafValue: function leafValue(value) {
      return 'K' + value;
    } }, obj);
  var expected = {
...
QUnit.test("main case - object traversal - BFS traverse", function exec_test(assert) {
  var lenses = _.objectTreeLenses;
  var traverse = {
    strategy: _.BFS,
    seed: [],
    visit: function visit(result, traversalState, tree) {
      var label = lenses.getLabel(tree);
      result.push(label);
  ...
  var actual = (0, _.traverseObj)(traverse, obj);
...
QUnit.test("main case - hashed-tree traversal - traverse", function exec_test(assert) {
  var traces = [];
  var lenses = (0, _.getHashedTreeLenses)('.');

  var traverse = {
    seed: [],
    visit: function visit(result, traversalState, obj) {
  ...
  function traverseHashedTree(lenses, traverse, obj) {
    return (0, _.breadthFirstTraverseTree)(lenses, traverse, obj);
  }
  ...
  var actual = traverseHashedTree(lenses, traverse, obj);
  var expected = ["0: root", "0,0: combinatorName", "0,1: componentName", "0,2: emits", "0,3: id", "0,4: logType", "0,5: path", "0,6: settings", "0,2,0: identifier", "0,2,1: notification", "0,2,2: type", "0,2,1,0: kind", "0,2,1,1: value", "0,2,1,1,0: key"];
...
QUnit.test("main case - hashed-tree traversal - map over", function exec_test(assert) {
  ...
  var actual = (0, _.mapOverHashTree)('.', function (label) {
    return 'M-' + label;
  }, obj);
  var expected = {
    "cursor": "0",
...
QUnit.test("main case - array tree traversal - traverse", function exec_test(assert) {
  var lenses = _.arrayTreeLenses;

  var traverse = {
    seed: [],
    visit: function visit(result, traversalState, tree) {
      var path = traversalState.get(tree).path;
      var parentLabel = lenses.getLabel(tree);
      var children = lenses.getChildren(tree);
      var graphNodes = children.map(function (child) {
        return {
          data: {
  ...
  var arrayTree = ['root', [['no_cd_loaded', ["cd_drawer_closed", "cd_drawer_open", "closing_cd_drawer"]], ['cd_loaded', [["cd_loaded_group", [["cd_paused_group", ["time_and_track_fields_not_blank", "time_and_track_fields_blank"]], "cd_playing", "cd_stopped"]], "stepping_forwards", "stepping_backwards"]]]];

  var actual = (0, _.breadthFirstTraverseTree)(lenses, traverse, arrayTree);
  var expected = [{
    "data": {
      "id": "no_cd_loaded.0",
      "label": "no_cd_loaded",
...
QUnit.test("main case - switching tree data structure - from label tree to array tree", function exec_test(assert) {
  var actual = (0, _.switchTreeDataStructure)(lenses, _.arrayTreeLenses, tree);
...
QUnit.test("main case - array tree traversal - postorder traversal", function exec_test(assert) {
  ...
  var traverse = {
    ...
    visit: function visit(result, traversalState, tree) {
      ...
      return result.concat({ path: path, label: label, children: children });
    }
  };

  var arrayTree = ["root", ["left", ["middle", ["midleft", "midright"]], "right"]];

  var actual = (0, _.postOrderTraverseTree)(lenses, traverse, arrayTree);
  var expected = [{
    "children": [],
    "label": "left",
    "path": [0, 0]
    ...
    "children": ["left", ["middle", ["midleft", "midright"]], "right"],
    "label": "root",
    "path": [0]
  }];
...
QUnit.test("main case - switching tree data structure - from array tree to label tree", function exec_test(assert) {
  var tree = ["root", ["left", ["middle", ["midleft", "midright"]], "right"]];
  var actual = (0, _.switchTreeDataStructure)(_.arrayTreeLenses, lenses, tree);
...
QUnit.test("main case - preorderTraverseTree - label tree - identical labels", function exec_test(assert) {
  ...
  var actual = (0, _.preorderTraverseTree)(lenses, traverse, tree);
  var expected = ["root", "same", "same", "midleft", "midright", "same"];
...
QUnit.test("main case - postorderTraverseTree - label tree - identical labels", function exec_test(assert) {
  ...
  var actual = (0, _.postOrderTraverseTree)(lenses, traverse, tree);
  var expected = ["same", "midleft", "midright", "same", "same", "root"];
...
QUnit.test("main case - bfsOrderTraverseTree - label tree - identical labels", function exec_test(assert) {
  ...
  var actual = (0, _.breadthFirstTraverseTree)(lenses, traverse, tree);
  var expected = ["root", "same", "same", "same", "midleft", "midright"];
...
QUnit.test("main case - preorder array tree traversal - traverse - identical labels", function exec_test(assert) {
  ...
  var arrayTree = ['root', [['no_cd_loaded', ["cd_drawer_closed", "cd_drawer_closed", "cd_drawer_closed"]], ['cd_loaded', [["cd_loaded_group", [["cd_paused_group", ["time_and_track_fields_not_blank", "time_and_track_fields_blank"]], "cd_playing", "cd_stopped"]], "stepping_forwards", "stepping_backwards"]]]];
...
QUnit.test("main case - postorder tree traversal - traverse - identical labels", function exec_test(assert) {
  ...
  var arrayTree = ['root', [['no_cd_loaded', ["cd_drawer_closed", "cd_drawer_closed", "cd_drawer_closed"]], ['cd_drawer_closed', [["cd_loaded_group", [["cd_paused_group", ["time_and_track_fields_not_blank", "time_and_track_fields_blank"]], "cd_playing", "cd_stopped"]], "stepping_forwards", "stepping_backwards"]]]];
...
},{"qunitjs":7,"../":6,"../index":6}],10:[function(require,module,exports) {
...
//# sourceMappingURL=/tree.specs.03c7cff0.map