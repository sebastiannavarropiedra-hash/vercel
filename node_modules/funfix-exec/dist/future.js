 ...
 */
import { Try, Success, Failure, Some, None, Either, Left, Right, IllegalStateError, IllegalArgumentError, TimeoutError, coreInternals } from "funfix-core";
...
export class Future {
     ...
     */
    delayResult(delay) {
        return this.transformWith(err => Future.delayedTick(delay, this._scheduler).flatMap(() => Future.raise(err, this._scheduler)), a => Future.delayedTick(delay, this._scheduler).map(() => a));
    }
    /**
...
export const FutureModule = {
    ...
    // ChainRec
    chainRec: (f, a) => Future.tailRecM(a, a => f(Either.left, Either.right, a))
};
