import { CompositeError, IllegalStateError, IllegalArgumentError, hashCodeOfString, NotImplementedError, Try, Success, Failure, Some, None, Either, Left, Right, TimeoutError, coreInternals } from 'funfix-core/dist/es5';
    ...
    createClass(Future, [{
        ...
        value: function map(f) {
            ...
            return this.transformWith(Future.raise, function (a) {
                return Future.pure(f(a), _this3._scheduler);
            });
        }
    }, {
        key: "recoverWith",
        ...
        value: function recover(f) {
            ...
            return this.transformWith(function (e) {
                return Future.pure(f(e), _this4._scheduler);
            }, function (a) {
                return Future.pure(a, _this4._scheduler);
            });
        }
    }, {
        key: "then",
        ...
        value: function delayResult(delay) {
            ...
            return this.transformWith(function (err) {
                return Future.delayedTick(delay, _this6._scheduler).flatMap(function () {
                    return Future.raise(err, _this6._scheduler);
                });
            }, function (a) {
                return Future.delayedTick(delay, _this6._scheduler).map(function () {
                    return a;
                });
            });
        }
        ...
        value: function timeoutTo(after, fallback) {
            var other = Future.delayedTick(after, this._scheduler).flatMap(function () {
                return fallback();
            });
            var lst = [this, other];
...
var PureFuture = function (_Future) {
    ...
    function PureFuture(_value, _scheduler) {
        ...
        var _this7 = possibleConstructorReturn(this, (PureFuture.__proto__ || Object.getPrototypeOf(PureFuture)).call(this));

        _this7._value = _value;
        _this7._scheduler = _scheduler;
        return _this7;
    }
        ...
        value: function tryComplete(r, ec) {
            ...
            var _ret = function () {
                switch (_this9.id) {
                    ...
                    case "chained":
                        var ref = _this9.ref.compressedRoot();
                        var result = ref.tryComplete(r, ec);
                        _this9.id = "complete";
                        _this9.ref = result ? r : ref.value().get();
                        return {
                            v: result
                        };
                }
...
var FutureModule = {
    ...
    chainRec: function chainRec(f, a) {
        return Future.tailRecM(a, function (a) {
...
var AsyncFuture = function (_Future2) {
    ...
    function AsyncFuture(state, cRef, ec) {
        ...
        var _this11 = possibleConstructorReturn(this, (AsyncFuture.__proto__ || Object.getPrototypeOf(AsyncFuture)).call(this));

        _this11["_state"] = state;
        _this11._scheduler = ec;
        if (cRef) _this11._cancelable = cRef;
        return _this11;
    }
...
var FutureMaker = function () {
    function FutureMaker(state, ec) {
        ...
        this.tryComplete = function (r) {
            return _this12["_state"].tryComplete(r, _this12._scheduler);
        };

        this.complete = function (r) {
            if (!_this12.tryComplete(r)) throw new IllegalStateError("Cannot complete a FutureMaker twice!");
        };
        this["_state"] = state;
        this._scheduler = ec;
    }
...
function futureTraverseLoop(list, f, parallelism, ec, index, result) {
    ...
    try {
        ...
        if (index >= list.length) {
            return fa.map(function () {
                return result;
            });
        } else {
            return fa.flatMap(function () {
