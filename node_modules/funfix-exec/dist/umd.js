...
funfixCore.coreInternals.fantasyLandRegister(Future, FutureModule);
...
var FutureMaker = function () {
    function FutureMaker(state, ec) {
        ...
        this.complete = function (r) {
            if (!_this12.tryComplete(r)) throw new funfixCore.IllegalStateError("Cannot complete a FutureMaker twice!");
        };
        this["_state"] = state;
        this._scheduler = ec;
    }
