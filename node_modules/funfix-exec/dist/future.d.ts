 ...
 * just fine.
 */
export declare abstract class Future<A> implements HK<"funfix/future", A>, IPromiseLike<A>, ICancelable {
    /**
     ...
     *        local overrides, being a {@link DynamicRef}
     */
    static raise<A = never>(e: Throwable, ec?: Scheduler): Future<A>;
    /**
 ...
 */
export declare type FutureTypes = Monad<"funfix/future">;
/**
 * Type-class implementations, compatible with the `static-land`
 * specification.
 */
export declare const FutureModule: FutureTypes;
/**
